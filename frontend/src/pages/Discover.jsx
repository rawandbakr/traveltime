    ...
    <div className=" pl-28 pt-10 bg-dicover bg-center bg-no-repeat bg-cover h-screen flex flex-col justify-around items-start">
      ...
      <div className=" flex flex-row items-start justify-start gap-10">
        <p className=" w-1/3 text-sm">
          ...
          maxime vel nemo beatae? Ut ad sequi doloribus, aspernatur rerum et qui
          quasi soluta modi tenetur, suscipit excepturi officia, nam
          perferendis.
        </p>
        <span className=" flex flex-row gap-5">
          <div className=" hover:scale-110 flex bg-video1 bg-cover bg-center  justify-center items-center w-48 h-32">
            <AiOutlinePlayCircle size={44} />
          </div>
          <div className="  hover:scale-110 flex bg-video2 bg-cover bg-center justify-center items-center w-48 h-32">
            <AiOutlinePlayCircle size={44} />
          </div>
        </span>
      </div>
